                     ...
                     _In_ int       nCmdShow)
{
    ...
    if (pWindow->Create({ _T("GLTF"), 1920, 1080, true, false }, hInstance))
    {
#ifdef _DEBUG
        Platform::DeviceCreateParams params{ true, true, 3, 2, pWindow->GetHWND(), 512 };
#else
        Platform::DeviceCreateParams params{ false, false, 3, 2, pWindow->GetHWND(), 512 };
#endif
