                     ...
                     _In_ int       nCmdShow)
{
    ...
    if (pWindow->Create({ _T("PBR"), 1920, 1080, true, false }, hInstance))
    {
#ifdef _DEBUG
        Platform::DeviceCreateParams params{ true, true, 3, 2, pWindow->GetHWND(), 256 };
#else
        Platform::DeviceCreateParams params{ false, false, 3, 2, pWindow->GetHWND(), 256 };
#endif
